...
const routes: Routes = [
  ...
  {path: 'users/:page', component: UsersComponent, canActivate:[RoleGuard], data: { roles: [Role.provisor]}},
  ...
  {path: 'wish_list/:page', component: WishListComponent, canActivate: [RoleGuard], data: { roles: [Role.loginUser]}},
